...
describe("CommunityVault", function () {
    ...
    describe("Contract Tests", function () {
        it("Mint entr tokens in community vault address", async function () {
            await entrToken.mint(communityVault.address, distributedAmount);
            expect(await entrToken.balanceOf(communityVault.address)).to.be.equal(distributedAmount);
        });
        ...
        it("should set allowance as owner", async function () {
            ...
            expect(await entrToken.allowance(communityVault.address, userAddr)).to.be.equal(distributedAmount);
        });
