...
describe("CommunityVault", function () {
    ...
    describe("Contract Tests", function () {
        it("Mint xyz tokens in community vault address", async function () {
            await xyzToken.mint(communityVault.address, distributedAmount);
            expect(await xyzToken.balanceOf(communityVault.address)).to.be.equal(distributedAmount);
        });
        ...
        it("should set allowance as owner", async function () {
            ...
            expect(await xyzToken.allowance(communityVault.address, userAddr)).to.be.equal(distributedAmount);
        });
